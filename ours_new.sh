...
# CIL CONFIG
NOTE="aser_sample_ver2" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="aser"
...
do
    CUDA_VISIBLE_DEVICES=1 nohup python main_new.py --mode $MODE --loss_balancing_option $LOSS_BALANCING_OPTION \
    ...
    --memory_size $MEM_SIZE --online_iter $ONLINE_ITER --curriculum_option $CURRICULUM_OPTION \
