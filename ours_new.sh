...
# CIL CONFIG
NOTE="ours_new_final_ver2_k2_t2" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ours"
...
do
    CUDA_VISIBLE_DEVICES=0 nohup python main_new.py --mode $MODE --loss_balancing_option $LOSS_BALANCING_OPTION \
