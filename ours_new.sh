...
# CIL CONFIG
NOTE="sdp_sigma10_mem_full_iter_0.25" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="sdp"
...
do
    CUDA_VISIBLE_DEVICES=6 nohup python main_new.py --mode $MODE --loss_balancing_option $LOSS_BALANCING_OPTION --data_dir ../../khs/ILSVRC/Data/CLS-LOC \
