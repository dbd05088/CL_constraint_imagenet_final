...
# CIL CONFIG
NOTE="cifar10_sigma10_test" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="ours"
...
do
    CUDA_VISIBLE_DEVICES=2 python main_new.py --mode $MODE --transform_on_worker \
