...
# CIL CONFIG
NOTE="aser_imagenet_0.0625_test" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="aser"
...
do
    ...
    --rnd_seed $RND_SEED --data_dir ../../../jihun/dataset/imagenet/ \
